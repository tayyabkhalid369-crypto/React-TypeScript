      ...
      <div className="card p-6 cursor-pointer h-full flex flex-col">
        <div className="flex flex-col items-center flex-1">
          <div className="relative mb-6">
            <div className="absolute inset-0 bg-gradient-to-br from-primary-400 to-primary-600 rounded-full blur-lg opacity-20 group-hover:opacity-30 transition-opacity"></div>
            <img
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-primary-600 font-medium">@{user.login.username}</p>
            <p className="text-xs text-dark-500 mt-1">{user.name.title}</p>
          </div>

          <div className="space-y-3 w-full text-sm mb-4">
            <div className="flex items-center gap-3 text-dark-600 bg-dark-50 p-3 rounded-lg">
